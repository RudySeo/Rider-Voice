...
class MvpSchemaMappingIntegrationTest : MySqlIntegrationTest() {
    ...
    private companion object {
        ...
        val EXPECTED_FOREIGN_KEYS = setOf(
            ...
            Triple("author_restaurant_review_states", "author_user_id", "users"),
            Triple("author_restaurant_review_states", "restaurant_id", "restaurants"),
            Triple("author_restaurant_review_states", "current_review_id", "reviews"),
        ...
        val EXPECTED_INDEXES = listOf(
            ...
            IndexSpec("reviews", "idx_reviews_author_restaurant_sequence", false, listOf("author_user_id", "restaurant_id", "submission_sequence")),
            IndexSpec("reviews", "idx_reviews_restaurant_visibility_created", false, listOf("restaurant_id", "visibility_status", "created_at", "id")),
            IndexSpec("author_restaurant_review_states", "uk_author_restaurant_review_states_author_restaurant", true, listOf("author_user_id", "restaurant_id")),
            IndexSpec("author_restaurant_review_states", "idx_author_restaurant_review_states_current_review", false, listOf("current_review_id")),
