...
class MvpSchemaMappingIntegrationTest : MySqlIntegrationTest() {
    ...
    private companion object {
        ...
        val EXPECTED_FOREIGN_KEYS = setOf(
            ...
            Triple("mobile_login_grants", "user_id", "users"),
            Triple("rider_invite_codes", "rotated_by_user_id", "users"),
            Triple("rider_verification_attempts", "user_id", "users"),
        ...
        val EXPECTED_INDEXES = listOf(
            ...
            IndexSpec("mobile_login_grants", "uk_mobile_login_grants_code_hash", true, listOf("code_hash")),
            IndexSpec("mobile_login_grants", "idx_mobile_login_grants_expiry", false, listOf("expires_at", "consumed_at")),
            IndexSpec("rider_invite_codes", "uk_rider_invite_codes_current_slot", true, listOf("current_slot")),
            IndexSpec("rider_invite_codes", "idx_rider_invite_codes_created", false, listOf("created_at", "id")),
            IndexSpec("rider_verification_attempts", "uk_rider_verification_attempts_user", true, listOf("user_id")),
            IndexSpec("rider_verification_attempts", "idx_rider_verification_attempts_locked_until", false, listOf("locked_until")),
