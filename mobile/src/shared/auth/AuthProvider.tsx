...
export type PendingIntent = { kind: 'activity' } | { kind: 'reviewSearch' } | { kind: 'existingReview'; restaurantId: number; place: string } | { kind: 'kakaoReview'; query: string; kakaoPlaceId: string; place: string };
