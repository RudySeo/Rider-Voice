...
export type paths = {
    ...
    "/api/v1/auth/oauth2/callback/kakao": {
        ...
        /**
         * 카카오 OAuth callback
         * @description OAuth 로그인을 완료한 뒤 일회용 교환 코드를 발급하고 Rider Voice 모바일 deep link로 redirect합니다.
         */
        get: {
            parameters: {
                query: {
            ...
            requestBody?: never;
            responses: {
                /** @description 일회용 code가 포함된 모바일 deep link로 이동 */
                302: {
                    headers: {
                        [name: string]: unknown;
                    };
...
export type components = {
    schemas: {
        ...
        MyReviewListResponse: {
            ...
            /**
             * Format: int64
             * @description 삭제·전체 제외를 포함한 전체 작성 건수
             */
            authoredCount?: number;
            /**
             * Format: int64
             * @description 현재 공개 중인 활성 리뷰 건수
             */
        ...
        RestaurantAggregateMetricResponse: {
            ...
            /** @description 항목별 응답의 1.0~5.0 환산 점수. 종합 별점이 아닙니다. */
            score?: number | null;
        };
...
export interface operations {
    ...
    exchange: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["MobileExchangeRequest"];
            };
        };
        responses: {
            /** @description OK */
